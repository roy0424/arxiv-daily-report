...
public class RssItemReader implements ItemReader<List<PaperDto>> {
    ...
    private List<PaperDto> fetchRss() {
        ...
        try {
            ...
            String updatedAt = ZonedDateTime.parse(pubDate, DateTimeFormatter.RFC_1123_DATE_TIME).toLocalDate().toString();
